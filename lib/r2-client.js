...
static async generateDownloadURL(fileKey, expiresIn = 3600) {
  console.log('🔄 generateDownloadURL llamado con key:', fileKey);
  
  try {
    // ✅ USAR el endpoint PÚBLICO para signed URLs
    ...
    console.log('✅ Generando URL firmada con endpoint público...');
