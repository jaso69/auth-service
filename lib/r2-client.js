  ...
  static async uploadDocument(file, documentId, options = {}) {
    try {
      ...
      if (file.buffer) {
        ...
        throw new Error('No se pudo obtener el contenido del archivo (buffer o data no encontrados)');
      }
