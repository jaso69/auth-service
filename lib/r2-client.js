...
static async generateDownloadURL(fileKey, expiresIn = 3600) {
  console.log('🔄 R2Client.generateDownloadURL llamado');
  console.log('🔑 Key recibida:', fileKey);
  ...
  try {
    ...
    console.log('✅ Comando creado, generando signedUrl...');
    
    const signedUrl = await getSignedUrl(s3Client, command, { 
      expiresIn 
    });

    console.log('✅ ✅ ✅ signedUrl generada EXITOSAMENTE');
    ...
    console.error('❌ ❌ ❌ ERROR CRÍTICO en generateDownloadURL:');
