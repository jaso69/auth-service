...
export async function getComunidadByNumero(numero) {
  ...
  if(numero === 3){
    comunidad = await db`SELECT * FROM comunidad3`;
  }
  if(numero === 4){
    comunidad = await db`SELECT * FROM comunidad4`;
  }
  if(numero === 5){
    comunidad = await db`SELECT * FROM comunidad5`;
  }
  if(numero === 6){
    comunidad = await db`SELECT * FROM comunidad6`;
  }
  if(numero === 7){
    comunidad = await db`SELECT * FROM comunidad7`;
  }
  if(numero === 8){
    comunidad = await db`SELECT * FROM comunidad8`;
  }
  if(numero === 9){
    comunidad = await db`SELECT * FROM comunidad9`;
  }
  if(numero === 10){
    comunidad = await db`SELECT * FROM comunidad10`;
  }
  if(numero === 11){
    comunidad = await db`SELECT * FROM comunidad11`;
  }
  if(numero === 12){
    comunidad = await db`SELECT * FROM comunidad12`;
  }
    return comunidad;
  } catch (error) {
